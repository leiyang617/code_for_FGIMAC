function [Xpaired,Ypaired,Xsingle,Ysingle,assign,NEWlabel,nSmp,nPaired] = gePartialData(View1Fea,View2Fea,label,pairPortion)
...
%xinjia
NEWlabel = label([find(sum(assign,2)==2); ...
    find(assign(:,2)==0 & assign(:,1)~=0); ...
    find(assign(:,1)==0 & assign(:,2)~=0)]);
